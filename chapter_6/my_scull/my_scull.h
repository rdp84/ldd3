...
#define MY_SCULL_IOC_MAGIC   'o'

#define MY_SCULL_IOCRESET    _IO(MY_SCULL_IOC_MAGIC, 0)

/*
 * S means "Set" through a ptr
 * T means "Tell" directly with the argument value
 * G means "Get": reply by setting through a ptr
 * Q means "Query": respone is on the return value
 * X means "eXchange": switch G and S atomically
 * H means "sHift": switch T and G atomoically
 */

#define MY_SCULL_IOCSQUANTUM _IOW(MY_SCULL_IOC_MAGIC,   1, int)
#define MY_SCULL_IOCSQSET    _IOW(MY_SCULL_IOC_MAGIC,   2, int)
#define MY_SCULL_IOCTQUANTUM _IO(MY_SCULL_IOC_MAGIC,    3)
#define MY_SCULL_IOCTQSET    _IO(MY_SCULL_IOC_MAGIC,    4)
#define MY_SCULL_IOCGQUANTUM _IOR(MY_SCULL_IOC_MAGIC,   5, int)
#define MY_SCULL_IOCGQSET    _IOR(MY_SCULL_IOC_MAGIC,   6, int)
#define MY_SCULL_IOCQQUANTUM _IO(MY_SCULL_IOC_MAGIC,    7)
#define MY_SCULL_IOCQQSET    _IO(MY_SCULL_IOC_MAGIC,    8)
#define MY_SCULL_IOCXQUANTUM _IOWR(MY_SCULL_IOC_MAGIC,  9, int)
#define MY_SCULL_IOCXQSET    _IOWR(MY_SCULL_IOC_MAGIC, 10, int)
#define MY_SCULL_IOCHQUANTUM _IO(MY_SCULL_IOC_MAGIC,   11)
#define MY_SCULL_IOCHQSET    _IO(MY_SCULL_IOC_MAGIC,   12)

#define MY_SCULL_IOC_MAXNR 12
